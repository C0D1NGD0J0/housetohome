  ...
  return (
  	<div className="sidebar_box">
			...
			<ul className="sidebar_menu">
				...
				<li><NavLink activeClassName="active" to="/admin/listings"><i className="fa fa-cogs"></i> Manage Listings</NavLink></li>
				<li><NavLink activeClassName="active" to="#!"><i className="fa fa-credit-card"></i> Billing</NavLink></li>
				<li><NavLink activeClassName="active" to="/admin/users"><i className="fa fa-cog"></i> Manage Users</NavLink></li>
